...
urlpatterns = [
    ...
    path('station/<slug:code>/status/',     station.APIView.as_view(),          name = 'statusUpdate'),
    path('station/<slug:code>/sighting/',   station.APIViewSighting.as_view(),  name = 'newSighting'),
